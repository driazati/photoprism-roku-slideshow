' From https://github.com/juliomalves/roku-libs/blob/master/source/utils/registry.brs
'********************************************************************
'**  RegistryService
'********************************************************************
...
function RegistryUtil() as Object
    registry = {
        ...
        read_or_default: function(key as String, default_value as String, section = "default" as String) as Dynamic
            value = m.read(key, section)
            if value <> invalid
                return value
            end if
